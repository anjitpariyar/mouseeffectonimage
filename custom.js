      ...
      var app = new PIXI.Application(display.innerWidth, display.innerHeight);
       display.appendChild(app.view);

        app.stage.interactive = true;
        var posX, displacementSprite, displacementFilter, anjit, vx;
        var container = new PIXI.Container();
        app.stage.addChild(container);

       PIXI.loader.add("ripple.png").add("anjit.jpg").load(setup);
      ...
      // Notice the scale is ‘0’ for the displacement, that’s because it will be set to a height as soon as the mouse moves.
            ...
            anjit = new PIXI.Sprite(PIXI.loader.resources["anjit.jpg"].texture);
            anjit.width = app.renderer.width;
            anjit.height = app.renderer.height;
            container.addChild(anjit);
